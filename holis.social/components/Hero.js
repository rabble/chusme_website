...
export function Hero({ title = "Organize your community. On your terms.", description = "Chusme is a community-powered platform to message, plan, fund, and grow — without ads, algorithms, or fear of being shut down.", cta = { text: "Launch the App", href: "https://app.holis.social" }, secondaryCta }) {
