...
export default async function handler(request: Request): Promise<Response> {
  const content = `
    <div class="with-sidebar">
      <div class="main-content">
        <h1>About Chusme</h1>
        <p><strong>Chusme is a platform for community organizers</strong> — built on open protocols, sustained by community contributions, and grounded in collective values. We offer groups the tools to coordinate, communicate, and grow — without relying on extractive, ad-driven platforms like Facebook or Slack.</p>
        ...
        <hr>
        <h2>Our Roots</h2>
        <p>Chusme is one part of a broader ecosystem of community tech, shaped by years of work in decentralized social platforms and community organizing. We're built by the same team behind:</p>
        <ul>
          ...
          <li><a href="https://verse-pbc.org"><strong>Verse PBC</strong></a> — A Public Benefit Corporation that builds resilient, public-interest infrastructure for community-owned apps. Verse supports projects like Chusme with a focus on care, transparency, and protocol-first architecture.</li>
        ...
        <ul>
          ...
          <li><strong>Community Governance</strong><br>Each group on Chusme sets its own norms, moderation flows, and decision-making models. Inspired by tools like <a href="https://www.loomio.com">Loomio</a>, not top-down feeds.</li>
          <li><strong>Transparency & Openness</strong><br>Chusme is open source. We publish roadmaps and welcome contributors who want to shape the direction of the platform.</li>
        </ul>
        <hr>
        <h2>Join Us</h2>
        <p>Chusme isn't just a product — it's a commons.</p>
        <ul>
        ...
        <p><a href="https://chusme.app">Start a group</a><br>
        <a href="https://rights.social">Read the Social Media Bill of Rights</a><br>
        <a href="https://github.com/verse/chusme">Contribute or collaborate</a></p>
      </div>
      ...
      <div class="sidebar">
        <div class="sidebar-box">
          ...
          <p>The name Chusme is a play on the Spanish word chisme, which means gossip — but not in a negative sense.</p>
          ...
          <p>Chusme is the good kind of gossip. The kind that builds relationships, shares vital information, and connects people to what's happening around them.</p>
          ...
          <p>Chusme is what happens in line at the market, in group chats after a meeting, at the edge of a protest march — where real organizing takes place.</p>
  ...
  const html = renderLayout({
    title: "About Chusme",
    description: "Chusme is a platform for community organizers — built on open protocols, sustained by community contributions, and grounded in collective values.",
    content
  });
