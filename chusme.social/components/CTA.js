...
export function CTA({ heading = "Ready to organize your community?", description = "Start a space, invite your people, and unlock tools together. Chusme is free, open, and built for you.", buttonText = "Get Started", buttonHref = "https://chusme.app" }) {
