...
// .wrangler/tmp/bundle-UEiBZ7/checked-fetch.js
...
<div class="about-section light-bg">
  ...
  <div class="team-others">
    ...
    <div class="team-others-grid">
      ...
      <div class="team-other">
        <span class="team-other-name">Mart\xEDn Dutra</span>
        <span class="team-other-role">iOS Developer</span>
      </div>
      <div class="team-other">
...
function createInvitePage(code, groupId, relay, isDirectProtocolInvite = false) {
  return `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
// .wrangler/tmp/bundle-UEiBZ7/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-UEiBZ7/middleware-loader.entry.ts
